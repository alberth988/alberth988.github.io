                             ...
                             <table class="table" id="tbl_productos_mas_vendidos">
                                 <thead>
                                     <tr class="text-danger">
                                        <th>Cod. producto</th> <!-- esto en comillas-->
                                         <th>Producto</th>
                     ...
                     <div class="card-body">
                         <div class="table-responsive">
                             <table class="table" id="tbl_productos_poco_stock">
                                 <thead>
                                     <tr class="text-danger">
                                         <th>Cod. producto</th><!-- esta entre comillas -->
                                         <th>Producto</th>
                     ...
                     animation: {
                         ...
                         onComplete: function() {
                            ...
                            for (var i = 0; i < this.data.datasets[1].data.length; i++) {
                                ...
                                var model = this.data.datasets[1]._meta[Object.keys(this.data.datasets[1]._meta)[0]].data[i]._model,scale_max = this.data.datasets[1]._meta[Object.keys(this.data.datasets[1]._meta)[0]].data[i]._yScale.maxHeight;                        
     ...
     function cargarProductosMasVendidos() {
         ...
         $.ajax({
             ...
             success: function(respuesta) {
                 ...
                 for (let i = 0; i < respuesta.length; i++) {
                     filas = '<tr>' +  
                         '<td>'+ respuesta[i]["codigo_producto"] + '</td>'+// Se crea un indice y el nombre de la BD
                         ...
                         '</tr>'
                     $("#tbl_productos_mas_vendidos tbody").append(filas);//append agrega 
                 }
