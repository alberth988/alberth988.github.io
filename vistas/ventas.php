                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <label class="col-form-label" for="iptCodigoCliente">
                                        ...
                                        <span class="small-10px">Cliente</span>
                                    </label>
                                    

                                    <input type="text" class="form-control form-control-sm" id="iptCodigoCliente" placeholder="Ingrese el nombre o dni del paciente">
                                </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <label class="col-form-label" for="iptCodigoVenta">
                                        <i class="fas fa-barcode fs-6"></i>
                                        <span class="small-10px">Productos</span>
                                    </label>
                                ...
                                <table id="lstProductosVenta" class="display nowrap table-striped w-100 shadow ">
                                    <thead class="bg-gray text-left fs-6">
                                        <tr>
                                            ...
                                            <th>Cantidad</th>
                                            <th>Precio</th>
                                            <th>Stock</th><!-- agregando-->
                                            <th>Clientek</th><!-- Cliejte-->
                                            <th>Crédito</th><!-- deuda-->
                                            <th>Total</th>
            ...
            if ($("#iptEfectivoRecibido").val() > 0 && $("#iptEfectivoRecibido").val() != "") {
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        window.open('http://localhost/clinica_dent/vistas/generar_ticket.php?nro_boleta='+nro_boleta);
