...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h2 class="m-0">Inventario / Clinica</h2>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                    <li class="breadcrumb-item active">Inventario / Clínica</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="d-block d-sm-none">
                                ...
                                <div style="width: 100%;" class="form-floating mx-1 my-1">
                                    <input type="text" id="iptProducto" class="form-control" data-index="4">
                                    <label for="iptProducto">Productoes</label>
                                </div>
                ...
                <table id="tbl_productos" class="table table-striped w-100 shadow border border-secondary">
                    <thead class="bg-gray">
                        <tr style="font-size: 15px;">
                            ...
                            <th>imagen </th><!-- 14 -->
                            <th class="text-center">Opciones</th> <!-- 15 -->
                        </tr>
                    </thead>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $("#tbl_productos").DataTable({
            dom: 'Bfrtip', //botonera en la parte superior
            buttons: [{
                ...
                'excel', 'print', 'pageLength' //agegamos botones 
            ],
